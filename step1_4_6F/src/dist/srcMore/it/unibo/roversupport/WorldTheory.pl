%==============================================
% WorldTheory.pl for actor roversupport
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturoversupport).	%%old version (deprecated)
actorobj(qaturoversupport).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor roversupport
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of roversupport" ). 
...
%-------------------------------------------------
%  User static rules about roversupport
%------------------------------------------------- 
/*
------------------------------------------------------------------------
