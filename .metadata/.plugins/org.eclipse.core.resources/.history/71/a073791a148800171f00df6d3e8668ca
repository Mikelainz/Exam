...
public abstract class AbstractRoversupport extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractRoversupport(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/roversupport/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/roversupport/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//senseEvent
	    		aar = planUtils.senseEvents( 60000,"sonar","handleSonar2",
	    ...
	    public boolean handleSonar2() throws Exception{	//public to allow reflection
	    try{
	    	int nPlanIter = 0;
	    	//curPlanInExec =  "handleSonar2";
	    	boolean returnValue = suspendWork;		//MARCHH2017
	    while(true){
	    	curPlanInExec =  "handleSonar2";	//within while since it can be lost by switchlan
	    	nPlanIter++;
	    		//onEvent
	    		if( currentEvent.getEventId().equals("sonar") ){
	    		 		String parg = "actorOp(goalTest(D))";
	    		 		/* ActorOp */
	    		 		parg =  updateVars( Term.createTerm("sonar(SONARID,TARGETNAME,DISTANCE)"), Term.createTerm("sonar(sonar2,wall_e,D)"), 
	    		...
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine, "goalEvent","goalEvent", guardVars ).toString();
	    		emit( "goalEvent", temporaryStr );
	    		}
	    		//we should restore nPlanIter and curPlanInExec of the 'interrupted' plan ???
	    		returnValue = continueWork;
	    break;
	    ...
	    return returnValue;
	       ...
	       //println( getName() + " plan=handleSonar2 WARNING:" + e.getMessage() );
	       QActorContext.terminateQActorSystem(this); 
	       return false;  
	    }
	    }
