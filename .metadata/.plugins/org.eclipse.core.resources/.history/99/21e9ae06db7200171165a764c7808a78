	...
	protected IActorAction  action;
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		temporaryStr = "\"Sonar2 STARTS\"";
	    		println( temporaryStr );  
	    		//delay
	    		aar = delayReactive(3000,"" , "");
	    		if( aar.getInterrupted() ) curPlanInExec   = "init";
	    		if( ! aar.getGoon() ) break;
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine, "sonar(SONARID,TARGETNAME,DISTANCE)","sonar(sonar2,wall_e,20)", guardVars ).toString();
	    		emit( "sonar", temporaryStr );
	    		temporaryStr = "\"EVENT SONAR EMITTED\"";
	    		println( temporaryStr );  
