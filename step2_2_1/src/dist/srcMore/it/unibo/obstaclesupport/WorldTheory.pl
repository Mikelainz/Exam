%==============================================
% WorldTheory.pl for actor obstaclesupport
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuobstaclesupport).	%%old version (deprecated)
actorobj(qatuobstaclesupport).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor obstaclesupport
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of obstaclesupport" ). 
...
%-------------------------------------------------
%  User static rules about obstaclesupport
%------------------------------------------------- 
/*
------------------------------------------------------------------------
