%==============================================
% WorldTheory.pl for actor sonarsupport
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarsupport).	%%old version (deprecated)
actorobj(qatusonarsupport).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarsupport
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarsupport" ). 
...
%-------------------------------------------------
%  User static rules about sonarsupport
%------------------------------------------------- 
