...
public abstract class AbstractObstaclesupport extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractObstaclesupport(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/obstaclesupport/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/obstaclesupport/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		temporaryStr = "\"[OBSTACLE_SUPPORT] STARTS\"";
	    		println( temporaryStr );  
	    		if( ! planUtils.switchToPlan("work").getGoon() ) break;
	    		temporaryStr = "\"[OBSTACLE_SUPPORT] ENDS\"";
	    		println( temporaryStr );  
	    break;
	    }//while
	    return returnValue;
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		//onMsg
	    		if( currentMessage.msgId().equals("checkObstacleType") ){
	    			String parg = "";
	    			/* SwitchPlan */
	    			parg =  updateVars(  Term.createTerm("checkObstacleType"), Term.createTerm("checkObstacleType"), 
	    				    		  					Term.createTerm(currentMessage.msgContent()), parg);
	    				if( parg != null ){
	    					 if( ! planUtils.switchToPlan("handleObstacle").getGoon() ) break; 
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//senseEvent
	    		aar = planUtils.senseEvents( 500,"sonarDetect","continue",
	    		...
	    		else{ temporaryStr = QActorUtils.unifyMsgContent(pengine, "noMoreObstacle","noMoreObstacle", guardVars ).toString();
	    		emit( "noMoreObstacle", temporaryStr );
