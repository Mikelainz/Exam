%==============================================
% WorldTheory.pl for actor usercmdsupport
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuusercmdsupport).	%%old version (deprecated)
actorobj(qatuusercmdsupport).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor usercmdsupport
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of usercmdsupport" ). 
...
%-------------------------------------------------
%  User static rules about usercmdsupport
%------------------------------------------------- 
/*
------------------------------------------------------------------------
